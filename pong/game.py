...
class Game:
    ...
    def __init__(self, window, window_width, window_height):
        ...
        # creating paddles in the left and right
    ...
    def _draw_score(self):
        ...
        # blit is to draw image onto another surface
        # width to one-fourth of the window
    ...
    def _handle_collision(self):
        ...
        # reversing the velocity if the ball touches the bottom or top part of the screen
        if ball.y + ball.RADIUS >= self.window_height:
            ball.y_vel *= -1
        elif ball.y - ball.RADIUS <= 0:
            ball.y_vel *= -1

        # if ball touches the paddle reverse horizontal vel and 
        # adjust vertical vel by where it touches the paddle
        if ball.x_vel < 0:
